...
class Flight extends ChangeNotifier {
  ...
  Flight({this.id = '', this.riser = 6.7835, this.bevel = 7.3154, this.topCrotch = true, this.topCrotchDistance = 0.0,
  this.bottomCrotch = true, this.bottomCrotchDistance = 0.0, this.bottomCrotchPost = false, this.numberOfSteps = 12,
  this.bottomPostList = const  <Post>[], this.rampPostList = const <RampPost>[], this.topPostList = const <Post>[], this.onHold = true, });


  factory Flight.copy(Flight obj) {
    return Flight(id: obj.id, riser: obj.riser, bevel: obj.bevel, topCrotch: obj.topCrotch, topCrotchDistance: obj.topCrotchDistance,
        bottomCrotch: obj.bottomCrotch, bottomCrotchDistance: obj.bottomCrotchDistance, bottomCrotchPost: obj.bottomCrotchPost,
        numberOfSteps: obj.numberOfSteps, bottomPostList: obj.bottomPostList, rampPostList: obj.rampPostList, topPostList: obj.topPostList);
  }
